...
urlpatterns = [
    ...
    path("pantheonForm/", views.pantheon_form_view, name="pantheon_url"),
    path("artifactForm/", views.artifact_form_view, name="artifact_url"),
    path("collectionForm/", views.collection_form_view, name="collection_url"),
    ...
    path("pantheon/", views.pantheon_show_view, name="show_pantheon_url"),
    path("artifact/", views.artifact_show_view, name="show_artifact_url"),
    path("collection/", views.collection_show_view, name="show_collection_url"),
    ...
    path("pantheon/<int:f_id>/change", views.pantheon_update_view, name="update_pantheon_url"),
    path("artifact/<int:f_id>/change", views.artifact_update_view, name="update_artifact_url"),
    path("collection/<int:f_id>/change", views.collection_update_view, name="update_collection_url"),
    ...
    path("artifact/<int:f_id>/change", views.artifact_delete_view, name="delete_artifact_url"),
